  ...
  return (
    <div className="App">
      ...
      <div className={showStudyTimer ? 'pt-24' : ''}>
        ...
        {/* Default fallback */}
        {!['student-dashboard', 'teacher-dashboard', 'notes', 'practice', 'mindfulness', 'calendar', 'progress', 'tutor', 'notifications', 'classes', 'study-planner', 'scheduled-tests', 'strengths-weaknesses', 'teacher-analytics', 'create-class', 'manage-classes', 'assignments'].includes(currentView) && (
          <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
            <div className="text-center">
