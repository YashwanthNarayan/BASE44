      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <ModernContainer className="py-8 max-w-4xl">
          ...
          <ModernCard className="shadow-lg">
            <ModernCardBody className="p-8">
              <div className="mb-8">
                <ModernHeading level={3} className="mb-4 text-gray-900 leading-relaxed">
                ...
                {currentQuestion.question_type !== 'mcq' && (
                  <div className="flex items-center gap-2 text-sm text-gray-600 bg-blue-50 px-4 py-2 rounded-lg">
                    ...
                    <span>Type your answer in the text area below</span>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-between items-center pt-6 border-t border-gray-100">
                ...
                <div className="flex items-center gap-3">
                  {!userAnswers[currentQuestion.id] && (
                    <ModernText variant="body-small" className="text-amber-600 font-medium flex items-center gap-1">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <ModernContainer className="py-8 max-w-4xl">
        <div className="text-center mb-10">
          ...
          <ModernHeading level={1} className="mb-4 text-gray-900 font-bold">
